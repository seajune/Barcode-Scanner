...
def get_pixel(img):
    get_img = []
    a = 136.1
    for j in range(0,(img.shape[1]-30)):
        if img[0][j] > a:
            get_img.append(255)
        else:
            get_img.append(0)  
